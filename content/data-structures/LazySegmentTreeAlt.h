 ...
 * Date: 2016-10-28
 * License: MIT
 * Source: https://github.com/SuprDewd/CompetitiveProgramming/blob/master/code/data-structures/segment_tree.cpp
 * Description: Lazy segment tree can handle range updates and all stuff.
 * Implement the node structure for your own use.
 * Time: O(\log N).
 * Status: tested on redoks
 */
#pragma once
